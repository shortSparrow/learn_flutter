...
class _AuthCardState extends State<AuthCard>
  ...
  late Animation<Size> _height_animation;
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: AnimatedBuilder(
        animation: _height_animation,
        builder: (context, child) {
          return Container(
            height: _height_animation.value.height,
            constraints: BoxConstraints(minHeight: _height_animation.value.height),
